...
int main()
{
	std::cout << " Test 1: Création de zombies sur le HEAP (avec newZombie)" << std::endl;
	std::cout << "Les zombies créés sur le heap doivent être explicitement supprimés\n" << std::endl;
	
	// Test 1: Zombies sur le heap
	std::cout << "Création d'un zombie Hipz_1 sur le heap :" << std::endl;
	...
	std::cout << "Les zombies créés sur la stack sont automatiquement détruits\n" << std::endl;
	
	// Test 2: Zombies sur la stack
	std::cout << "Création et annonce automatique de Stakz_1 :" << std::endl;
	randomChump("Stakz_1");
	
	std::cout << "Création et annonce automatique de Stakz_2 :" << std::endl;
	randomChump("Stakz_2");
	
	std::cout << "Création et annonce automatique de Stakz_3 :" << std::endl;
	randomChump("Stakz_3");
	...
	// Zombie sur le heap (survit au scope)
